...
export const BOOK_CONTENT = 'Book personal para demostrar proyectos y habilidades de programación. Construido en Nuxt.js como framework principal, Jest com framework para pruebas unitarias y Cypress para pruebas de integración. Se utilizó Bootstrap para implementar responsividad y estoy trabajando en integrar Less o Sass para eficientizar/ordenar los estilos.'
